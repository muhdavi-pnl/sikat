...
Route::middleware('guest')->group(function () {
    ...
    Route::get('auth/google', [GoogleAuthenticatedSessionController::class, 'redirect'])->name('auth.google.redirect');
...
Route::middleware('auth')->group(function () {
    Route::get('force-change-password', [ForcedPasswordController::class, 'edit'])
        ->name('password.force.edit');

    Route::put('force-change-password', [ForcedPasswordController::class, 'update'])
