<x-app-layout>
    ...
    @section('title', 'Layanan Fungsional')
    <x-slot name="header">
        <h1>Layanan</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div>
            <div class="breadcrumb-item">Layanan Fungsional</div>
        </div>
    </x-slot>

    <div class="section-body">
        <h2 class="section-title">Layanan Fungsional</h2>
        <p class="section-lead">
            Semua layanan terkait Fungsional Dosen dapat Anda temukan disini.
        </p>
                ...
                <div class="card">
                    ...
                    <div class="collapse" id="layanan-{{ $layanan->id }}" style="">
                        ...
                        <div class="card-footer text-right">
                            <button onclick="window.location='{{ route('layanan.buat-usulan', $layanan->id) }}'" class="btn btn-primary">Buat Usulan</button>
                        </div>
                    </div>
                </div>
            </div>
